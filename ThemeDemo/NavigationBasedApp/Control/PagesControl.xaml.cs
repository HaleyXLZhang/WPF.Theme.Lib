using HSBC.MPF.MailingCommon;
using HSBC.MPF.MailingCommon.DatabaseModel;
...
namespace NavigationTheme
{
    ...
    public partial class PagesControl : UserControl
    {
        ...
        private ObservableCollection<EmailRequestSubmitFormRequestTable> emailRequests;
        ...
        public void ShowPages(DataGrid grd, DataTable ds, int Num, ObservableCollection<EmailRequestSubmitFormRequestTable> emailRequests = null)
        {
        ...
        private void DisplayPagingInfo()
        {
            ...
            this.tbkRecords.Text = string.Format("Per page {0} / Totle {1}", this.pageNum, this.allNum);
            int first = (this.pIndex - 4) > 0 ? (this.pIndex - 4) : 1;
            int last = (first + 5) > this.MaxIndex ? this.MaxIndex : (first + 5);
